<?php
	...
	$sql = "select * from news order by creattime desc";
    ...
    <div class="col-sm-10 col-xs-10 col-md-10 col-lg-10 table-content">
		...
		if(!empty($data)){
            ...
            <tr>
              ...
              <td class="operation"><a type="submit" class="btn btn-danger btn-a" id="modify" href="article/modify.php?id=<?php echo $value['id']?>">修改</a><a type="submit" class="btn btn-danger btn-a" id="delete"  href="article/del.handle.php?id=<?php echo $value['id']?>">删除</a></td>
            </tr>
            <?php
        		}
		}
        ...
        <div class="news">
          ...
          <form id="form1" name="form1" method="post" action="article/add.handle.php" enctype="multipart/form-data">
            ...
            <div class="margin-bottom-10">
              ...
              <input class="col-lg-11 col-md-11 col-sm-11" type="file" name="picture" id="picture" />
            </div>
            <div class="margin-bottom-10"> 
